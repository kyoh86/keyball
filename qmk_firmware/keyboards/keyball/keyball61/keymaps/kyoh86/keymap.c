...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    KC_LALT,         KC_NO,           KC_P4,           KC_P5,           KC_P6,           KC_NO,                                                  KC_PGUP,         KC_BTN1,         KC_DOWN,         KC_BTN2,         KC_PGDN,         KC_LALT,
  ...
  [2] = LAYOUT_universal(
    ...
    TO(0),           KC_6,            KC_7,            KC_8,            KC_ESC,          KC_SPC,          KC_LSFT,              KC_BSPC,         KC_ENT,          KC_NO,           KC_NO,           KC_NO,           KC_P0,           KC_DOT
  ),
